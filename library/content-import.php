...
add_action('wp_ajax_theme_import_products', 'ThemeContentImport::importProductsAction', 9);
add_action('wp_ajax_theme_replace_products', 'ThemeContentImport::replaceProductsAction', 9);
