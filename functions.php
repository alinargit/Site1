...
function blog_sorting() {
    $blog_sorting_options = array(
        'name_asc'  => __('Name, A to Z', 'site1'),
        'name_desc' => __('Name, Z to A', 'site1'),
        'date_asc'  => __('Date, old to new', 'site1'),
        'date_desc' => __('Date, new to old', 'site1'),
    );
